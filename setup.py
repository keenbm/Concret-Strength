...
PROJECT_NAME="concret-strength-prediction"
VERSION="0.0.1"
AUTHOR="Bhavik Modi"
DESRCIPTION="Predicting concret strength using MLOPS concept"
PACKAGES=["concret"]
...
# (to install internal custom packages i.e. concret-strength v.0.0.1)


## -e. ->> This will install internal custom packages (i.e. concret-strength v.0.0.1 )
